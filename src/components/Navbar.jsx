...
export default function Navbar() {
    return (
        <nav className="lg:w-full w-fit  backdrop-blur-md bg-surface/60  shadow-primary/20 text-stone-900 py-4 px-10 flex justify-center lg:justify-between items-center shadow-lg rounded-xl  mx-auto max-w-6xl">
